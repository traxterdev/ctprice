 ...
 *
 * O mecanismo de background (`url()`, `background-size:cover`, `background-position:50% 50%`,
 * sem overlay/gradiente) é idêntico ao já usado em internal-hero.php — não há necessidade de nova
 * infraestrutura de background aqui, apenas as mesmas propriedades CSS.
 *
...
?>
<section class="boxed-hero" style="background-image: url('<?= htmlspecialchars($image, ENT_QUOTES, 'UTF-8') ?>');">
