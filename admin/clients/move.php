<?php
/**
 * admin/clients/move.php
 *
 * Reordenação simples por setas (subir/descer) — ver §14 da tarefa: sem drag-and-drop.
 */
...
try {
    ...
    error_log('CT Price CMS [admin/clients/move]: ' . $e->getMessage());
